...
export const quickActions = [
  ...
  { title: 'Medical Records', desc: 'Access your history.', icon: 'bi-folder2-open', tone: 'teal-tint', href: 'appointment-history.html' },
  { title: 'Request Prescription', desc: 'Renew your meds.', icon: 'bi-capsule', tone: 'amber-tint', href: 'messages.html' },
  { title: 'Update Profile', desc: 'Manage your info.', icon: 'bi-person-gear', tone: 'amber-tint-2', href: 'profile.html' },
  { title: 'Contact Hospital', desc: 'Get in touch with us.', icon: 'bi-telephone', tone: 'neutral', href: 'messages.html' },
];
